...
public class ShophttpService extends HttpServiceHelper {
	...
	// URL
	private  final String BASE_URI = SERVICE_URL+"shop/";
	// 分页获得数据
	private  final String DATA_ALL = BASE_URI + "data_all";
	// id搜索
	private  final String DATA_BYID = BASE_URI + "data_byId";
	// 类型搜索
	...
	// 添加
	private  final String DATA_ADD = BASE_URI + "data_add";
	//
