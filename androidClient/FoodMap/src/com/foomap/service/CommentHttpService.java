...
public class CommentHttpService extends HttpServiceHelper {
	...
	private final String BASE_URL = SERVICE_URL + "comment/";
	protected final String ACTION_ADD = BASE_URL + "comment_add";
	protected final String ACTION_GET_BY_ID = BASE_URL + "comment_byId";
	protected final String ACTION_UPIMG = BASE_URL + "comment_up";
